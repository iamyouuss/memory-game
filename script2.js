...
// let startButton = document.getElementById('start'); let stopButton = document.getElementById('stop'); let resetButton = document.getElementById('reset');  
// let tempo = 0; 
// let intervallo;  

// function aggiornaCronometro() {     
//     tempo ++;      // Aggiorna il valore del cronometro sulla console    
    
//     cronometroElemento.textContent = tempo;      console.log(tempo);       
// }      

// startButton.addEventListener('click', function() {     intervallo = setInterval(aggiornaCronometro, 1000); // Avvia il cronometro ogni secondo 
// });